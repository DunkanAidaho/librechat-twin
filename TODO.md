...
### 1. Size-aware RAG cache (Оптимизация #6)
- **Что нужно сделать**
...
### 2. Unified AbortController chain (Оптимизация #10)
- **Что нужно сделать**
...
### 3. Adaptive RAG retry strategy (Оптимизация #8)
- **Что нужно сделать**
...
### 4. Дополнительная сверка Mongo ↔ pgvector (если доступно)
- **Что нужно сделать**
...
### 5. Size-aware ragCache + TTL мониторинги
- **Что нужно сделать**
...
### 6. Abort-safe memory queue (следствие из #10)
- **Что нужно сделать**
...
### 7. Рефакторинг Token Breakdown логики (повторная проверка)
- **Что нужно сделать**
...
### 8. Headless и non-headless: единые контракты логов
- **Что нужно сделать**
