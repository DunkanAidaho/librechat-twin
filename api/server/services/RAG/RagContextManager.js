...
const POLICY_INTRO =
  'Ниже предоставлен внутренний RAG-контекст: граф знаний и выдержки из беседы. ' +
  'Используй его релевантно к запросу для формирования точного и полного ответа, уделяя внимание качеству анализа.\n\n';
