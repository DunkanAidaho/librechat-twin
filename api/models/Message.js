...
// ... (весь существующий код до функции saveMessage)
...
// =========================================================================
// НОВАЯ ФУНКЦИЯ: Подсчет ветвлений для диалога
// =========================================================================
/**
 * Counts the number of branches in a given conversation.
 * A branch is considered to exist if there are multiple messages sharing the same parentMessageId,
 * excluding the root message (parentMessageId: null).
 *
 * @async
 * @function getBranchCountForConversation
 * @param {string} conversationId - The ID of the conversation.
 * @param {string} userId - The ID of the user.
 * @returns {Promise<number>} The number of unique parentMessageIds that have more than one child.
